...
} from "https://esm.sh/three-stdlib@2.29.4?deps=three@0.161.0";
...
const ambientLight = new AmbientLight(new Color("white"), 0.8); // soft white light
...
(async function () {
  ...
  let textures = {
    stone: new Color("gray"),
    dirt: new Color("brown"),
    dirt2: new Color("saddlebrown"),
    grass: new Color("green"),
    sand: new Color("yellow"),
    water: new Color("blue"),
  };
